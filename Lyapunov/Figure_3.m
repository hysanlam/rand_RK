...
for trial=1:numer_trials
    ...
    parfor count=1:length(rank_rk4)
        ...
        for dt = time
            Y_randDLRA = Y_inital;
            for i=1:(T/dt)
                Y_randDLRA = randDLRA_rk_4(Y_randDLRA,F,(i-1)*dt,i*dt,r,stream,"constant_sketch");
            end
            %ref = odeSolver(Y0,F,0,i*dt);
            err_randDLRA = norm(matFull(1,Y_randDLRA,r) - ref, 'fro');
            errTable_randDLRA = [errTable_randDLRA,err_randDLRA];
...
for trial=1:numer_trials
    ...
    parfor count=1:length(rank_rk2)
        ...
        for dt = time
            Y_randDLRA = Y_inital;
            for i=1:(T/dt)
                Y_randDLRA = randDLRA_rk_2(Y_randDLRA,F,(i-1)*dt,i*dt,r,stream,"non constant_sketch");
            end
            %ref = odeSolver(Y0,F,0,i*dt);
            err_randDLRA = norm(matFull(1,Y_randDLRA,r) - ref, 'fro');
            errTable_randDLRA = [errTable_randDLRA,err_randDLRA];
...
for trial=1:numer_trials
    ...
    parfor count=1:length(rank_rk2)
        ...
        for dt = time
            Y_randDLRA = Y_inital;
            for i=1:(T/dt)
                Y_randDLRA = randDLRA_rk_2(Y_randDLRA,F,(i-1)*dt,i*dt,r,stream,"constant_sketch");
            end
            %ref = odeSolver(Y0,F,0,i*dt);
            err_randDLRA = norm(matFull(1,Y_randDLRA,r) - ref, 'fro');
            errTable_randDLRA = [errTable_randDLRA,err_randDLRA];
